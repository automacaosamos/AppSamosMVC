...
function TConexoesFactory.pegaConexao(): TFDConnection;
var
...
function TConexoesFactory.Abre_Tabelas(TextSQL:String):TFDQuery;
var
 Query : TFDQuery;
begin
...
//-----------------------------------------------------------------
function TConexoesFactory.ExecutaScriptSQL(SQLScript:String):Boolean;
//-----------------------------------------------------------------
var
  DQuery  : TFDQuery;
begin
...
function TConexoesFactory.TotalRegistros(F_SQL:String):Integer;
var
  Query : TFDQuery;
begin
  try
...
function TConexoesFactory.Ultimo_ID(Tabela,Status:String):Integer;
var
 Query : TFDQuery;
begin
  Query             := TFDQuery.Create(nil);
