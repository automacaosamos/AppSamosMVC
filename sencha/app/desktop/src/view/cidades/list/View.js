Ext.define('AppSamos.view.cidades.list.View', {
    extend: 'Ext.Panel',
    xtype: 'cidadeslist',

    requires: [
       'AppSamos.view.cidades.form.View',
       'AppSamos.view.cidades.list.ViewController',
       'AppSamos.view.cidades.list.ViewModel'
    ],
    ...
    controller: 'cidadeslist',
    viewModel: 'cidadeslist',
