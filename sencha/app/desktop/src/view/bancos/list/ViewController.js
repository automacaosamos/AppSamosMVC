Ext.define('AppSamos.view.bancos.list.ViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.bancoslist',
    ...
    onIncluirClick: function(btn, e) {
        ...
        const novaUsuarios = Ext.create('AppSamos.view.bancos.Model');
    ...
    onSairClick: function(btn, e){
        this.getViewModel().getStore('bancos').removeAll();
