Ext.define('AppSamos.view.permissoes.search.View', {
    extend: 'Ext.Panel',
    xtype: 'permissoessearch',

    requires: [
       'AppSamos.view.permissoes.form.View',
       'AppSamos.view.permissoes.search.ViewController',
       'AppSamos.view.permissoes.search.ViewModel'
    ],
    ...
    controller: 'permissoessearch',
    viewModel : 'permissoessearch',
