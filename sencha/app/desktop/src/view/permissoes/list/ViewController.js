Ext.define('AppSamos.view.permissoes.list.ViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.permissoeslist',
    ...
    onBuscarClick: function(btn, e) {
        const storeBancos = this.getViewModel().getStore('permissoes');
    ...
    onIncluirClick: function(btn, e) {
        ...
        const novaUsuarios = Ext.create('AppSamos.view.permissoes.Model');
    ...
    onSairClick: function(btn, e){
        this.getViewModel().getStore('permissoes').removeAll();
